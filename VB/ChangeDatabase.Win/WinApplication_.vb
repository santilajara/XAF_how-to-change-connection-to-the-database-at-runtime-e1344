...
Namespace ChangeDatabase.Win
	Partial Public Class ChangeDatabaseWindowsFormsApplication
		...
		Public Shared Function CreateApplication() As ChangeDatabaseWindowsFormsApplication
			...
			'Dim activeDirectoryAuthentication As New WinChangeDatabaseActiveDirectoryAuthentication()
			'activeDirectoryAuthentication.CreateUserAutomatically = True
			'CType(winApplication.Security, SecurityBase).Authentication = activeDirectoryAuthentication
