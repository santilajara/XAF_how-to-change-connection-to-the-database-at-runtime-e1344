...
Namespace ChangeDatabase.Module
	Public Class Updater
		...
		Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
            ...
            If CType(ObjectSpace, ObjectSpace).Session.ConnectionString.Contains("DB1") Then
                ...
                End If
            End If
            If CType(ObjectSpace, ObjectSpace).Session.ConnectionString.Contains("DB2") Then
