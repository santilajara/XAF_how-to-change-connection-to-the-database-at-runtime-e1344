...
'INSTANT VB NOTE: The field skipLogonDialog was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private Shared skipLogonDialog_Conflict As Boolean = False
		...
		Public Shared Property SkipLogonDialog() As Boolean
			Get
				Return skipLogonDialog_Conflict
			End Get
			Set(ByVal value As Boolean)
				skipLogonDialog_Conflict = value
			End Set
		End Property
	End Class
